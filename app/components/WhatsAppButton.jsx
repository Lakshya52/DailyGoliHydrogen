...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Pulse Effect - limited to 3 iterations to reduce compositor overhead */}
      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-40 animate-ping -z-10" style={{animationIterationCount: 3}}></span>
    </a>
  );
};
